...
local  = PhantomForcesWindow:NewSection(" Xịn xò🤡🤡")

Bloxfruit:CreateToggle("Auto Lever", function()function CheckQuest() 
...
Blox fruit:CreateToggle("Auto fast attack", function()new = {}
...
Bloxfruit:CreateToggle("Auto fast attack2", function()Toggle:OnChanged(function(Value)
      UFFF = Value
    end)
...
Bloxfruit:CreateToggle("Auto Bone", function()_G.Auto_Bone = Value
  ...
  Bloxfruit:CreateToggle("Auto Random bone", function()Toggle:OnChanged(function(Value)
...
Bloxfruit:CreateToggle("Auto Đảo Bánh", function()Toggle:OnChanged(function(Value)
...
Bloxfruit:CreateToggle("fast attack3", function()local Dropdown = Tabs.Settings:AddDropdown("Dropdown", {
...
Bloxfruit:CreateToggle("Auto Đứng trên nc", function()Toggle = Tabs.Lc:AddToggle("MyToggle", {Title = "Walk On Water", Default = false })
    Toggle:OnChanged(function(Value)
  _G.WalkWater = Value
		end)
		...
		Bloxfruit:CreateToggle("Auto Dịch chuyển TP", function()Toggle:OnChanged(function(Value)
        BypassTP = Value		
    end)
    
    Bloxfruit:CreateToggle("Auto Vô lại sv", function()Description = "",
        Callback = function()
            game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
        end
    })
    
    Blox fruit:CreateToggle("Auto star melee", function()task.spawn(function()
	while wait() do
		pcall(function()
...
Bloxfruit:CreateToggle("Shop fruit", function()Description = "",
        Callback = function()
    ...
    Bloxfruitl:CreateToggle("Qua đảo", function()Toggle:OnChanged(function(Value)
...
Bloxfruit:CreateToggle("Thức tỉnh ác quỷ", function()_G.Auto_Awakener = Value
		end)
...
Bloxfruit:CreateToggle("Kill aura", function()Toggle:OnChanged(function(Value)
   _G.concubu = Value
		end)
...
Bloxfruit:CreateToggle("fast attack3", function()Values = {"0", "0.1", "0.15", "0.155", "0.16", "0.165", "0.17", "0.175", "0.18", "0.185"},
        Multi = false,
        Default = 1,
    })
...
Bloxfruit:CreateToggle("Auto haki", function()Toggle:OnChanged(function(Value)
        _G.AUTOHAKI = Value
    end)
...
Bloxfruit:CreateToggle("Anti Afk", function()Toggle:OnChanged(function(Value)
...
Bloxfruitl:CreateToggle("Số quái bánh", function()spawn(function()
        while wait() do
            pcall(function()
